...
print(f'The area of a cylinder with a height of {height} and a radius of {radius} is {cylinder.calc_area(radius, height)}.')
print(f'The volume of a cylinder with a height of {height} and a radius of {radius} is {cylinder.calc_volume(radius, height)}.')