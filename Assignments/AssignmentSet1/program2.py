# Description: A program that takes user input of a cylinder's height & radius, and prints the resulting volume & area of the cylinder by calling functions from cylinder.py
...
print(f'The area of a cylinder with a height of {height} and a radius of {radius} is {cylinder_area:,.2f}.')
print(f'The volume of a cylinder with a height of {height} and a radius of {radius} is {cylinder_volume:,.2f}.')